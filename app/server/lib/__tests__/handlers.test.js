...
test('getTokens', () => {
  ...
  expect(handlers.getFunGetTokens(getFunGetResponseJSON, DB2)(app('test'))(req, res, next)).toEqual(
    {
      result: 'ERR',
      description:
        'Something went wrong -- ощибка БД SELECT * FROM telephones WHERE telephone_number = ?',
  ...
  expect(handlers.getFunGetTokens(getFunGetResponseJSON, DB3)(app('test'))(req, res, next)).toEqual(
    {
      result: 'ERR',
  ...
  expect(handlers.getFunGetTokens(getFunGetResponseJSON, DB4)(app('test'))(req, res, next)).toEqual(
    {
      result: 'ERR',
      description: 'The account associated with this phone number is marked for deletion.',
      responseCode: '0001004',
  ...
  expect(handlers.getFunGetTokens(getFunGetResponseJSON, DB5)(app('test'))(req, res, next)).toEqual(
    {
      result: 'ERR',
      description:
  ...
  expect(handlers.getFunGetTokens(getFunGetResponseJSON, DB6)(app('test'))(req, res, next)).toEqual(
    {
      result: 'ERR',
      description:
        'Something went wrong -- ощибка БД SELECT * FROM smscodes WHERE telephone_id = ? AND smscode_timeLastAttempt > ?',
  ...
  expect(handlers.getFunGetTokens(getFunGetResponseJSON, DB7)(app('test'))(req, res, next)).toEqual(
    {
      result: 'ERR',
  ...
  expect(handlers.getFunGetTokens(getFunGetResponseJSON, DB8)(app('test'))(req, res, next)).toEqual(
    {
      result: 'ERR',
  ...
  expect(handlers.getFunGetTokens(getFunGetResponseJSON, DB9)(app('test'))(req, res, next)).toEqual(
    {
      result: 'ERR',
  ...
  expect(
    handlers.getFunGetTokens(getFunGetResponseJSON, DB10)(app('test'))(req, res, next),
  ).toEqual({
    result: 'ERR',
    description: 'Something went wrong -- ощибка БД SELECT * FROM owners WHERE user_id = ?',
    responseCode: '0001003',
  ...
  expect(
    handlers.getFunGetTokens(getFunGetResponseJSON, DB11)(app('test'))(req, res, next),
  ).toEqual({
    result: 'ERR',
    description: 'Something went wrong -- ощибка БД SELECT * FROM owners WHERE user_id = ?',
    responseCode: '0001003',
